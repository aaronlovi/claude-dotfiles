...
- **Self-review**: All stages (1-6) include a self-review convergence loop that iteratively refines the output artifact until stable (max 5 passes). Stage 7 has its own convergence loop built in. See `commands/self-review-protocol.md` for the shared protocol.
